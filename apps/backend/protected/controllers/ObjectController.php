...
class ObjectController extends BeController
{
        public function __construct($id,$module=null)
	{
		 parent::__construct($id,$module);
                 $this->menu=array(
                        array('label'=>t('cms','Manage Content'), 'url'=>array('admin'),'linkOptions'=>array('class'=>'button')),
                        array('label'=>t('cms','Create Content'), 'url'=>array('create'),'linkOptions'=>array('class'=>'button')),
                );
	...
	{            
              ...
              $this->menu=array_merge($this->menu,                       
                        array(
                            array('label'=>t('cms','Update this content'), 'url'=>array('update','id'=>$id),'linkOptions'=>array('class'=>'button')),
                            array('label'=>t('cms','View this content'), 'url'=>array('view','id'=>$id),'linkOptions'=>array('class'=>'button'))
                        )
                    );
