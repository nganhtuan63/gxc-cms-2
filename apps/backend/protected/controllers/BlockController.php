 ...
 *
 */
class BlockController extends BeController{
        ...
        public function __construct($id,$module=null)
	{
		 parent::__construct($id,$module);
                 $this->menu=array(
                        array('label'=>t('cms','Manage Block'), 'url'=>array('admin'),'linkOptions'=>array('class'=>'button')),
                        array('label'=>t('cms','Add Block'), 'url'=>array('create'),'linkOptions'=>array('class'=>'button')),
                );
	...
	{         
              ...
              $this->menu=array_merge($this->menu,                       
                        array(
                            array('label'=>t('cms','Update this Block'), 'url'=>array('update','id'=>$id),'linkOptions'=>array('class'=>'button')),
                            array('label'=>t('cms','View this Block'), 'url'=>array('view','id'=>$id),'linkOptions'=>array('class'=>'button'))
                        )
                    );
