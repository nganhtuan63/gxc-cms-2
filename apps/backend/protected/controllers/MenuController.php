 ...
 *
 */
class MenuController extends BeController{
        ...
        public function __construct($id,$module=null)
	{
		 parent::__construct($id,$module);
                 $this->menu=array(
                        array('label'=>t('cms','Manage Menu'), 'url'=>array('admin'),'linkOptions'=>array('class'=>'button')),
                        array('label'=>t('cms','Add Menu'), 'url'=>array('create'),'linkOptions'=>array('class'=>'button')),
                );
