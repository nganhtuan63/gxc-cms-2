 ...
 *
 */
class ContentlistController extends BeController{
        ...
        public function __construct($id,$module=null)
	{
		 parent::__construct($id,$module);
                 $this->menu=array(
                        array('label'=>t('cms','Manage Content List'), 'url'=>array('admin'),'linkOptions'=>array('class'=>'button')),
                        array('label'=>t('cms','Create new Content List'), 'url'=>array('create'),'linkOptions'=>array('class'=>'button')),
                );
	...
	{         
              ...
              $this->menu=array_merge($this->menu,                       
                        array(
                            array('label'=>t('cms','Update this Content list'), 'url'=>array('update','id'=>$id),'linkOptions'=>array('class'=>'button')),
                            array('label'=>t('cms','View this Content list'), 'url'=>array('view','id'=>$id),'linkOptions'=>array('class'=>'button'))
                        )
                    );
