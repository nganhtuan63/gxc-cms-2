        ...
        <div class="content-box-content" style="display: block; padding: 0 0 15px 0">
                <div class="tab-content default-tab">
                         <div class="row">
                                ...
                                <?php echo CHtml::label(t('cms','Add content'),''); ?>
...
<div class="closed-box content-box ">
	...
	<div class="row">
        <?php echo CHtml::submitButton(isset($_GET['action']) ?  t('cms','Save') :  t('cms','Add'), array('class'=>'button')); ?>
	</div>
	<?php else : ?>
	<div class="row">
