	...
	'columns'=>array(
		...
		(
			...
			(
			   'label'=>t('cms','Translate'),
			    'imageUrl'=>false,
			    'url'=>'Yii::app()->createUrl("admin/'.app()->controller->id.'/create", array("guid"=>$data->guid,"type"=>$data->type))',
			),
		    ),
		),                 			
		array
		(
			...
			(
			    'label'=>t('cms','Edit'),
			    'imageUrl'=>false,
			    'url'=>'Yii::app()->createUrl("admin/'.app()->controller->id.'/update", array("id"=>$data->taxonomy_id))',
			),
		    ),
		),
                array
