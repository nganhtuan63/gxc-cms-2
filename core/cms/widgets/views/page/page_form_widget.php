   ...
   <div class="row">
    ...
    <div class="row" style="border-top: 1px dotted #CCC; padding-top:20px">
       <?php echo $form->labelEx($model,'parent'); ?>
        <p class="hint"><?php echo  t('cms','Use Select box or Autocomplete box for Parent Select : ');?></p>
        ...
        <input onClick="return changePageParent();" type="button" class="button" name="btnchangeParent" value="<?php echo  t('cms','Apply Parent Blocks');?>" />                      
    ...
    <div class="row" style="border-bottom:1px dotted #CCC; padding:0px 0px 20px 0">
        ...
        <div id="block-buttons" style="margin-top:30px">
            <input type="button" class="button" onClick="inheritFromParent();" name="inherit-parent-block" value="<?php echo  t('cms','Inherit from Parent'); ?>" />
            <input type="button" class="button" onClick="addExistedBlock();" name="add-existed-block" value="<?php echo  t('cms','Add existed Block'); ?>" />
            <input type="button" class="button" onClick="addNewBlock();" name="add-new-block" value="<?php echo  t('cms','Add new Block'); ?>" />
        </div>
    </div>
