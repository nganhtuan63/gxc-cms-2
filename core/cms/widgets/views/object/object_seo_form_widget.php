                          <div class="content-box-header">
                            ...
                            <h3><?php echo  t('cms','Summary & SEO');?></h3>
                             <ul class="content-box-tabs">
                                <li><a class="default-tab current" href="#summary_box"><?php echo  t('cms','Summary');?></a></li>
                                <li><a href="#seo_box" class=""><?php echo  t('cms','SEO');?></a></li>
                             </ul>
                            </div> 
