<input type="hidden" value="1" name="which_button" id="which_button"/>
                                        <div class="row odd buttons border-left-silver">                                                                                       
                                            &nbsp;<lablel class="status_label" style="display: block"><?php echo  t('cms','Send to Person: '); ?></lablel>
                                            ...
                                            <?php echo CHtml::Button(t('cms','Send'),array('style'=>'width:100px;','class'=>'button active','onClick'=>'return doFormSend();')); ?>
                                            <lablel class="status_label" style="display: block"><?php echo  t('cms','Send to: '); ?></lablel>
                                            <?php echo $form->dropDownList($model,'object_status',$content_status,array('class'=>'status_select')); ?>
                                            <?php echo CHtml::Button(t('cms','Send'),array('class'=>'button active','onClick'=>'return doFormSave();','style'=>'display:block;width:100px')); ?>
                                                    <div class="clear"></div>
                                                    ...
                                                    <script type="text/javascript">
                                                            ...
                                                            function doFormSend(){
                                                                    ...
                                                                    if(formPerson==''){
                                                                            alert('<?php echo t("cms","Please choose a name");?>');
                                                                            return false;
                                                                    } else {
