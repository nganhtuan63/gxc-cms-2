...
<div class="content-box ">
        ...
        <h3><?php echo  t('cms','Resources');?></h3>    
            	...
            	<?php foreach ($content_resources as $key=>$value) : ?>
            		<div class="tab-content" id="<?php echo $key; ?>_box">
            			...
            			<div class="button_add" style="text-align:right; padding-right:10px; padding-top:10px; padding-bottom:10px">
                   			<input type="button" onClick="return doUploadResource('<?php echo $key; ?>');" class="bebutton active" name="<?php echo $key; ?>_button" id="<?php echo $key; ?>_button" value="<?php echo  t('cms','Add'); ?>"/>
                   		</div>
                	</div> 
        		<?php endforeach; ?>
    		<?php endif; ?>
