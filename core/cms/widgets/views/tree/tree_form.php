                    ...
                    <ul id='list-item-ul' name="list-item" class="ui-sortable" >    
                        <li name="new-item" id="li_item_id-0" align="left" style="display:none;" class="list_item_wrapper">                            
                            ...
                            <div class="item_div_wrapper">                                                             
                                <span class="item_name"><?php echo  t('cms','Item'); ?></span>                                
                                <span class="item_id" style="display:none">0</span>
                                <span class="item_parent_id" style="display:none">0</span>
                                <br />
                                <span class="item_buttons">
                                <a href="javascript:void(0)" onClick="fnEditItem(this);" name="editItem"><?php echo  t('cms','Edit'); ?></a> |
                                 <a href="javascript:void(0)" onClick="fnAddNextItem(this);" name="addNextItem"><?php echo  t('cms','Add next item'); ?></a> |
                                <a href="javascript:void(0)" onClick="fnAddItem(this);" name="addSubItem"><?php echo  t('cms','Add sub item'); ?></a> |                                 
                                <a href="javascript:void(0)" onClick="fnRemoveItem(this);"  name="removeItem"><?php echo  t('cms','Remove'); ?></a>  
                                </span>                                
                            </div>
...
<script type="text/javascript">
        ...
        function fnRemoveItem(object){
             if(confirm('<?php echo  t('cms','Are you sure you want to delete?'); ?>')){
                var current_id= $(object).parent().parent().children('span.item_id').html();                                           
                var th=object;                                        
...
<?php echo CHtml::button(t('cms','New item'),array('class'=>'button','name'=>'btnNewItem')); ?> 
</div>
