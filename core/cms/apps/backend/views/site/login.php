...
<div>
<?php echo t('cms','Please fill in your Username and Password'); ?>    
    <?php if (user()->isGuest) echo t('cms','Guest'); else echo t('cms','Member') ; ?>
</div>
</div>
...
<div class="clear"></div>
<div>
    <?php echo CHtml::submitButton(t('cms','Login'),array('id'=>'login-content-button','class'=>'bebutton')); ?>
