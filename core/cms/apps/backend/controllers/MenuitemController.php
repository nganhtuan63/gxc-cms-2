 ...
 *
 */
class MenuitemController extends BeController{
        ...
        public function __construct($id,$module=null)
	{
		 parent::__construct($id,$module);
                 $this->menu=array(
                        array('label'=>t('cms','Manage Menu Item'), 'url'=>array('admin'),'linkOptions'=>array('class'=>'button')),
                        array('label'=>t('cms','Add Menu Item'), 'url'=>array('create'),'linkOptions'=>array('class'=>'button')),
                );
	...
	{         
              ...
              $this->menu=array_merge($this->menu,                       
                        array(
                            array('label'=>t('cms','Update this Menu Item'), 'url'=>array('update','id'=>$id),'linkOptions'=>array('class'=>'button')),
                            array('label'=>t('cms','View this Menu Item'), 'url'=>array('view','id'=>$id),'linkOptions'=>array('class'=>'button'))
                        )
                    );
