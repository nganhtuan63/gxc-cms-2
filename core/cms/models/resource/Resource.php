...
class Resource extends CActiveRecord
{
	...
	{
		return array(
			'resource_id' =>  t('cms','Id'),
			'resource_name' =>  t('cms','Resource Name'),
			'resource_body' =>  t('cms','Resource Body'),
			'resource_path' =>  t('cms','Resource Path'),
			'resource_type' =>  t('cms','Type'),
			'created' =>  t('cms','Created'),
			'updated' =>  t('cms','Updated'),
			'creator' =>  t('cms','Author'),
			'where' =>  t('cms','Storage'),
