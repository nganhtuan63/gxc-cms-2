...
class Object extends CActiveRecord
{
        ...
        public function checkTags($attribute,$params)
	{
        ...
        public static function extraLabel(){
			...
			'object_author' =>  t('cms','Object Author'),
			'object_date' =>  t('cms','Object Date'),
			'object_date_gmt' =>  t('cms','Object Date Gmt'),
			'object_content' =>  t('cms','Object Content'),
			'object_title' =>  t('cms','Object Title'),
			'object_excerpt' =>  t('cms','Object Excerpt'),
			'object_status' =>  t('cms','Object Status'),
			'comment_status' =>  t('cms','Comment Status'),
			'object_password' =>  t('cms','Object Password'),
			'object_name' =>  t('cms','Object Name'),
			'object_modified' =>  t('cms','Object Modified'),
			'object_modified_gmt' =>  t('cms','Object Modified Gmt'),
			'object_content_filtered' =>  t('cms','Object Content Filtered'),
			'object_parent' =>  t('cms','Object Parent'),
			'guid' =>  t('cms','Guid'),
			'object_type' =>  t('cms','Object Type'),
			'comment_count' =>  t('cms','Comment Count'),
			'object_slug' =>  t('cms','Object Slug'),
			'object_description' =>  t('cms','Object Description'),
			'object_keywords' =>  t('cms','Object Keywords'),
			'lang' =>  t('cms','Language'),
			'object_author_name' =>  t('cms','Object Author Name'),
			'total_number_meta' =>  t('cms','Total Number Meta'),
			'total_number_resource' =>  t('cms','Total Number Resource'),
			'tags' =>  t('cms','Tags'),
			'object_view' =>  t('cms','Object View'),
			'like' =>  t('cms','Like'),
			'dislike' =>  t('cms','Dislike'),
